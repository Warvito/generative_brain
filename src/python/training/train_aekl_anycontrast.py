...
from util import get_dataloader_anycontrast, log_mlflow
...
def main(args):
    ...
    print("Getting data...")
    cache_dir = output_dir / "cached_data_aekl_anycontrast"
    cache_dir.mkdir(exist_ok=True)

    train_loader, val_loader = get_dataloader_anycontrast(
        cache_dir=cache_dir,
