...
from training_functions import train_upsampler_ldm
from transformers import CLIPTextModel
from util import get_upsampler_dataloader, log_mlflow
...
def main(args):
    ...
    print("Getting data...")
    cache_dir = output_dir / "cached_data_upsampler_diffusion"
