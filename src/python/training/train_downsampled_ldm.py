...
from util import get_downsampled_dataloader, log_mlflow
...
def main(args):
    ...
    print("Getting data...")
    cache_dir = output_dir / "cached_data_downsampled_diffusion"
    cache_dir.mkdir(exist_ok=True)

    train_loader, val_loader = get_downsampled_dataloader(
        cache_dir=cache_dir,
